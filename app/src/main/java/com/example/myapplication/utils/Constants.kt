...
object Constants {
    ...
    data class Country( val country: String, val region: String)
...
"""
        ...
        val countryList: List<Country> = gson.fromJson(json, countryListType)
        return countryList.map { it.country }
    }
